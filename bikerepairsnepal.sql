...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2022 at 07:58 PM
...
CREATE TABLE `customer_vehicles` (
  ...
  `preinfo` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(5, '2021_01_06_120234_create_permission_tables', 1),
(6, '2021_01_28_082709_create_jobs_table', 1),
(7, '2022_06_25_083046_customer_vehicle_table', 1),
(8, '2022_06_27_091130_service_activities', 1),
(9, '2022_06_29_061332_customer_resolved_record', 1),
(10, '2022_07_06_221429_book_customer_table', 1),
(11, '2022_07_06_221645_book_customer_vehicle_table', 1);
...
INSERT INTO `users` (`id`, `frst_name`, `last_name`, `mobile_no`, `address`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'BikeRepairs', 'Nepal', '9802350866', 'Satungal', '$2y$10$O7QpRZVeYFUsMzP6AJixCuHyP/UdAey/c30N71ekifmockaPkwANq', NULL, NULL, NULL);
...
--
ALTER TABLE `customer_vehicles`
  ADD CONSTRAINT `customer_vehicles_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
