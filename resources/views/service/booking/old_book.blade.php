...
@section('content')
            ...
            <div class="content-wrapper">
                <div class="col-12 grid-margin">
                    ...
                    <div class="d-flex justify-content-between">
                        <h3 class="font-weight-semibold">Book For Servicing</h3>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="frst_name"
                                        data-parsley-required-message="Name Required" data-parsley-trigger="focusin focusout"
                                        required value="{{ $customer->frst_name }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Last name</label>
                                    <input type="text" id="last_name" class="form-control" value="{{ $customer->last_name }}"
                                        readonly data-parsley-required-message="Name Required"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="mobile_no" class="form-control" value="{{ $customer->mobile_no }}"
                                        readonly data-parsley-required-message="Mobile Number Required"
                                        data-parsley-trigger="focusin focusout" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" class="form-control" value="{{ $customer->address }}"
                                        readonly data-parsley-required-message="Address Required"
                                        data-parsley-trigger="focusin focusout" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                @foreach ($customer_vehicle as $vehicle)
                                    ...
                                    <form method="POST" class="form-sample"
                                        action="{{ route('customer.oldbook_store', $vehicle->id) }}" id="content_form"
                                            ...
                                            <div class="card text-white" style="background-color:#DE6449">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between pb-2 align-items-center">
                                                        <h3 class="font-weight-semibold mb-0">{{ $vehicle->v_no }}</h3>
                        ...
                        <div class="col-md-12">
                            ...
                            @role('superadmin')
                                <h5 class="text-justify">
                                    To add new vehicles or update information of current vehicles, click <b>Update
                                        Details</b>.<br>
                                    <a href="{{ route('customer.edit', $customer->id) }}">
                                        <button type="button" name="update" id="update" class="btn btn-primary"
                                            style="margin-bottom:5%;margin-top:1%;">Update Details</button></a>
                                </h5>
                            @endrole
    ...
    <script>
        ...
        $(this).on("click", "#add", function() {
            ...
            html +=
                '<label for="">Vehicle No</label><input type="text" name="v_no[]" id="v_no" placeholder="Enter Vehicle Number" class="form-control" required>';
            html +=
                '<label for="">Service Date</label><input type="datetime-local" name="date[]" id="date" class="form-control" required>';
            html +=
                '<label for="">Distance Covered (Kilometers)</label><input type="text" name="distance[]" id="distance" placeholder="Enter Distance Covered" class="form-control" required>';
            html +=
                '<label for="">Delivery</label><select class="form-control" name="delivery[]" id="delivery"><option>Select option</option><option value="self">Self</option><option value="pick/drop">Pick/Drop</option></select><br>';
            html +=
                '<label for="">Vehicle Service</label><input type="text" name="v_remarks[]" id="v_remarks" placeholder="Vehicle color/brand name" class="form-control" required>';
            html +=
                '<br><button type="button" name="remove" id="" class="btn btn-danger remove" style="margin-bottom:2%;margin-top:2%;">Remove</button></div>';
