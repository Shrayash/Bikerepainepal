...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        public function show($id)
        {
                ...
                $customer_vehicle = DB::table('customer_vehicles')->where('customer_vehicles.customer_id','=',$id)->where('customer_vehicles.v_status','=','in use')->get()->toArray();
        ...
        public function edit($id)
    {
        ...
        $customer_vehicle = DB::table('customer_vehicles')->where('customer_vehicles.customer_id','=',$id)->get()->toArray();
        return view('customer.edit')->with('customer', $customer)->with('customer_vehicle',$customer_vehicle);
